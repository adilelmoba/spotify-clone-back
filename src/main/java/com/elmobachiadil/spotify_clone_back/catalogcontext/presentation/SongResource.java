package com.elmobachiadil.spotify_clone_back.catalogcontext.presentation;

import com.elmobachiadil.spotify_clone_back.catalogcontext.application.SongService;
...
import com.elmobachiadil.spotify_clone_back.usercontext.application.UserService;
...
public class SongResource {
    ...
    public ResponseEntity<ReadSongInfoDTO> add(
        ...
        saveSongDTO = new SaveSongDTO(saveSongDTO.title(),
                saveSongDTO.author(),
                cover.getBytes(),
        ...
        if(!violations.isEmpty()) {
            ...
            ProblemDetail validationIssue = ProblemDetail
                    .forStatusAndDetail(HttpStatus.BAD_REQUEST, "Validation errors for the fields : " + violationsJoined);

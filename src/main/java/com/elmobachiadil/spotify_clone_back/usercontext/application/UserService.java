package com.elmobachiadil.spotify_clone_back.usercontext.application;
...
import com.elmobachiadil.spotify_clone_back.usercontext.mapper.UserMapper;
import com.elmobachiadil.spotify_clone_back.usercontext.repository.UserRepository;
...
public class UserService {
    ...
    private User mapOauth2AttributesToUser(Map<String, Object> attributes) {
        ...
        if(attributes.get("peferred_username") != null) {
            username = ((String) attributes.get("peferred_username")).toLowerCase();
        }
